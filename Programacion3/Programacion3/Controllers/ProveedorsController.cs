...
namespace Programacion3.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdProveedor,Cedula,Nombre,Telefono,Email")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProveedor,Cedula,Nombre,Telefono,Email")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {
